                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            if (strcasecmp($estado, $borrador) == 0) { ?>
                                                <>
                                                    <a href="#" role="button" title="editar"><svg xmlns="http://www.w3.org/2000/svg"
                                                            width="35" height="35" fill="green" class="bi bi-pencil-square"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                    ...
                                                    <a href="#" title="Eliminar" role="button">
