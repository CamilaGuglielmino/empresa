            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <?php  if(strcasecmp($tipo, $editar)==0){?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="#!">Bienvenido <?php echo $session->get('nombreUsuario')?></a></li>
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo base_url('Noticias/logout') ?>">Salir</a>
                                    </li>
                                </ul>
                            </li>
                <?php } elseif (strcasecmp($tipo, $publicador)==0){ ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item">Bienvenido <?php echo $session->get('nombreUsuario')?></a></li>
                        ...
                        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo base_url('login') ?>">Ingresar</a>
                                    </li><?php }?>
                                </ul>
                            </li>
                        </ul>
